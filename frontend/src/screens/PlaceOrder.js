...
const PlaceOrder = () => {
  ...
  const { shippingAddress: sAddress } = useSelector(
...
const {paymentMethod:pMethod}=useSelector(state=>state.paymentMethod)
  ...
  updatedCart.shippingPrice = addDecimals(
    updatedCart.itemsPrice > 1000 ? 0 : 100
  );
          ...
          <ListGroup variant="flush">
            ...
            <ListGroup.Item>
              ...
              <p>
                ...
                {sAddress.address}, {sAddress.city} {sAddress.postalCode},{" "}
                {sAddress.country}
              </p>
            </ListGroup.Item>
            {/* <ListGroup.Item>
